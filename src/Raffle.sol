...
contract Raffle is VRFConsumerBaseV2Plus{
    ...
    constructor(uint256 entranceFee, uint interval, address vrfCoordinator, bytes32 gasLine, uint256 subscriptionId, uint32 callbackGasLimit) VRFConsumerBaseV2Plus(vrfCoordinator) {
